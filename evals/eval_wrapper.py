        ...
        with torch.no_grad():
            with torch.autocast(device_type=device_str):
                for prefix_batch, cont_batch in zip(
                    ...
                    ll = self.model_shell.module.loglikelihood(prefix_batch, cont_batch) ## added the 'module' attribute (https://discuss.pytorch.org/t/access-to-attributes-of-model-wrapped-in-ddp/130572/2)
